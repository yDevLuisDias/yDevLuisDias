...
- 🤖 **Inteligência Artificial e Machine Learning**: Aprendizado de máquina, pré-processamento de dados e análise de padrões  
- 🖥️ **Desenvolvimento Back-end**: Java, Spring Boot  
- 📖 **Leitura e Aprendizado Contínuo**: Tecnologia, produtividade e desenvolvimento pessoal  
...
💻 **Buscando oportunidades na interseção de Desenvolvimento, Dados e IA**  
