...
> **Finalista do Programa iFood GenAI (2025)** — Top 100 entre mais de 20.000 candidatos (Top 0,5%), selecionado pela capacidade de construir soluções reais com Inteligência Artificial Generativa.
...
API REST de conta bancária com autenticação via **Spring Security**, persistência em PostgreSQL com JPA e arquitetura em camadas (core/infra).
...
Aplicação Java para leitura, validação e exportação de arquivos CSV, separando registros válidos de inválidos com tratamento de exceções.
...
Jogo educativo em JavaScript puro que ensina lógica de programação (condicionais, loops, funções) através de missões sobre sustentabilidade, inspirado na COP30.
...
<details>
<summary>🚧 Em desenvolvimento</summary>
<br>

**[ETL-Process](https://github.com/yDevLuisDias/ETL-Process)** — PoC de pipeline ETL com Spring Batch para ingestão de arquivos CSV/JSON/XML. Em construção.
...
![GitHub stats](https://github-readme-stats.vercel.app/api?username=yDevLuisDias&show_icons=true&theme=default&hide_border=true)
